  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row lg:flex-row justify-around my-10">
        <a
          href="#"
          className="mx-5 mt-2 mb-3 md:mb-0 lg:mb-0 flex flex-col items-center justify-center h-full text-[10px] md:text-xs lg:text-base md:w-1/2 lg:w-1/2 no-underline text-white bg-black border border-white rounded shadow hover:bg-white hover:text-black active:bg-white active:text-black"
        >
          <img
            src={visaLogo}
        ...
        <a
          href="#"
          className="mx-5 mt-2 py-3 flex flex-col items-center justify-center h-full text-[10px] md:text-xs lg:text-base md:w-1/2 lg:w-1/2 no-underline text-white bg-black border border-white rounded shadow hover:bg-white hover:text-black active:bg-white active:text-black"
        >
      ...
      <div className="mx-5 mt-2 mb-10 flex flex-col items-center md:block lg:block">
      ...
      <div className="mx-5 mt-5 mb-25 text-white flex flex-col items-center md:block lg:block">
