            ...
            <tr key={index}>
              <td className="py-2">
                <div className="p-0 mx-3 bg-white rounded">
                  <span className="text-black font-medium">{row.symbol}</span>
                </div>
              </td>
              <td>{row.name}</td>
              <td>
                <div className="p-0 border-2 border-white rounded-lg bg-[#01fd1f]">
                  <span className="text-black font-medium">{row.exchange}</span>
                </div>
              </td>
              <td>
                <div className="p-0 border-2 border-white rounded-lg bg-[#8677FF] mx-3">
                  <span className="text-black font-medium">{row.volume}</span>
                </div>
              </td>
            </tr>
          ))}
