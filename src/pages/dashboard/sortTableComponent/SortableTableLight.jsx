  ...
  return (
    ...
    >
      <table
        ...
        style={{ width: "100%", fontSize: "16px", backgroundColor: "#e9ecef" }}
      >
        <thead
        ...
        <tbody className="text-center">
          {tableData.map((row, index) => (
            <tr key={index}>
              <td className="py-2">
                <div className="card p-0 mx-3 bg-dark">
                  <span className="text-light fw-medium">{row.symbol}</span>
                </div>
              </td>
              <td className="text-dark">{row.name}</td>
              <td>
                <div
                  className="card p-0 border border-dark border-2 rounded-3"
              ...
              <td>
                <div
                  className="card p-0 border border-dark border-2 mx-3 rounded-3"
