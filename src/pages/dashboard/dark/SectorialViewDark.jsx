        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-2 md:mb-10 lg:mb-10">
          ...
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={financeSectorData} columns={columns} />
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-2 md:mb-10 lg:mb-10">
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={energySectorData} columns={columns} />
            )}
          </div>
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            <p className="text-white text-xs md:text-sm lg:text-base mb-1">
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-2 md:mb-10 lg:mb-10">
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={consumerGoodsData} columns={columns} />
            )}
          </div>
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            <p className="text-white text-xs md:text-sm lg:text-base mb-1">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={utilitiesData} columns={columns} />
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-2 md:mb-10 lg:mb-10">
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={industrialsData} columns={columns} />
            )}
          </div>
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            <p className="text-white text-xs md:text-sm lg:text-base mb-1">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={realEstateData} columns={columns} />
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-2 md:mb-10 lg:mb-10">
          ...
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={materialsSectorData} columns={columns} />
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row lg:flex-row justify-around px-4 mb-25">
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={fintechSectorData} columns={columns} />
            )}
          </div>
          <div className="flex flex-col md:w-[40%] my-4 md:my-0">
            <p className="text-white text-xs md:text-sm lg:text-base mb-1">
            ...
            {dataLoading ? (
              ...
              <SortableTableDark data={insuranceSectorData} columns={columns} />
            )}
          </div>
        </div>
      </div>
