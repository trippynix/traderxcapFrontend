  ...
  const changeBarData = [
    {
      type: "Call Chng",
      value: filteredData.reduce(
        (sum, item) => sum + (item.call_change_in_oi || 0),
        0
      ),
    },
    {
      type: "Put Chng",
      value: filteredData.reduce(
        (sum, item) => sum + (item.put_change_in_oi || 0),
        0
      ),
    },
  ];
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col w-full bg-black">
          ...
          <div className="flex flex-row justify-around items-center">
            ...
            <div className="relative flex border border-white rounded-full items-center justify-center my-4">
              <div
              ...
              <label
                className={`${
                  selectedOption === "Equities" ? "text-black" : "text-white"
              ...
              <label
                className={`${
                  selectedOption === "ETFs" ? "text-black" : "text-white"
          ...
          {selectedOption === "ETFs" && (
            <>
              ...
              <div className="my-10 px-4">
                <OIChart data={etfBarData} />
              </div>

              <div className="flex flex-col md:flex-row lg:flex-row mb-10 px-4">
                <div className="w-full md:w-[70%] lg:w-[70%] mr-0 md:mr-4 lg:mr-4 mb-10">
                  <OIPieChart data={etfPieData} />
                </div>
                <div className="w-full md:w-[30%] lg:w-[30%]">
                  <OIChangeBarGraph data={etfChangeBarData} />
                </div>
              </div>
